import { SimulationOptions, PassengerPath } from '../../../../../app/pkg/simulation';
...
export const PushPassengerPath = (pID:number, p: PassengerPath): SimulationAction => ({
    type: SimulationActionTypes.PUSH_PASSENGER_PATHS,
    payload: { pPath: { pID:pID, path: p }}
});